package vn.vnpost.example.unomi.client;
...
import vn.vnpost.example.unomi.builder.UnomiQueryBuilder;
import vn.vnpost.example.unomi.dto.UnomiEventRequest;
import vn.vnpost.example.unomi.dto.UnomiProfileRequest;
import vn.vnpost.example.unomi.dto.UnomiProfileSearchRequest;
...
public class UnomiClient {
    ...
    public Mono<Object> sendEvent(UnomiEventRequest request) {
        ...
        vn.vnpost.example.unomi.dto.UnomiEventItem eventItem = vn.vnpost.example.unomi.dto.UnomiEventItem.builder()
        ...
        vn.vnpost.example.unomi.dto.UnomiEventCollectorPayload payload =
                vn.vnpost.example.unomi.dto.UnomiEventCollectorPayload.builder()
