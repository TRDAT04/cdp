...
public class ProfileMergeExecutorService {
    ...
    private Mono<Void> writeFieldConflicts(ProfileSourceRecord sourceRecord, NormalizedProfileData data,
        ...
        String incomingPhone  = vn.vnpost.cdp.common.utils.IdentityUtils.normalizePhone(data.getPhone());
        String targetPhone    = vn.vnpost.cdp.common.utils.IdentityUtils.normalizePhone(target.getPhone());
        String incomingEmail  = vn.vnpost.cdp.common.utils.IdentityUtils.normalizeEmail(data.getEmail());
        String targetEmail    = vn.vnpost.cdp.common.utils.IdentityUtils.normalizeEmail(target.getEmail());
        String incomingIdNo   = vn.vnpost.cdp.common.utils.IdentityUtils.normalizeText(data.getIdentityNo());
        String targetIdNo     = vn.vnpost.cdp.common.utils.IdentityUtils.normalizeText(target.getIdentityNo());
